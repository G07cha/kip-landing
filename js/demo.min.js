var ENDPOINT="http://kip-messenger.us-west-2.elasticbeanstalk.com";function request(b){return fetch(ENDPOINT+b).then(function(a){return a.json()})}var API={processMessage:function(b,a){return request("/processMessage?author="+b+"&message="+a)}},List=function(b,a){a=void 0===a?{}:a;this.container=document.querySelector(b);this.settings=a};
